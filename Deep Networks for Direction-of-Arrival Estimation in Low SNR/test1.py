...
class Data_Loader(Dataset):
    def __init__(self, data_path):
        ...
        self.image_reg = data['reg_test']  # 将matlab中的3通道矩阵数据赋值给python变量
        self.label_reg = data['labelreg_test']  # 将matlab中的标签数据赋值给python变量
    ...
    def __getitem__(self, index):
        ...
        data_label = label_reg[index].reshape(181)
        # print(type(image_reg))
        # print(data_label)
...
if __name__ == "__main__":
    dataset = Data_Loader('./DNN/DNN_SNR-10.mat')
