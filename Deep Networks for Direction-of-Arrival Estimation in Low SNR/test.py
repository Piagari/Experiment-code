import numpy as np
import torch
from CNN_0 import Conv, FC, last_layer, CNN
from test1 import Data_Loader
...
batch_size = 64
device = torch.device("cuda")
model1 = torch.load("example_SNR2099.pth")
...
for data in train_dataloader:
    ...
    #     k += 1
    #     reg_c = output[i, ::].cpu().detach().numpy()  # 因为output_c的batchsize是32，所以说包含着32个一维向量，相当于包含着32个方位普
